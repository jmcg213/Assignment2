...
DoughnutMode::DoughnutMode(int height, int width, double den)
{
  col = height;
  rows = width;
  density = den;
...
void DoughnutMode::GenerateGrid(string input)   //generates a grid if user does not implement one in their file
{
  if(oput == "console")
    cin.ignore();
  string temp;
  ...
  if(input == "file")
  {
    ic.CountGrid(ic.GetFileName(), present);
  }
  else
  {
...
void DoughnutMode::CountNeighbors()   //counts neighbors and then fills the future array with what is meant to happen
{
  ...
  for(int i = 0; i < col; ++i)
  {
    for(int j = 0; j < rows; ++j)
    {
      ...
      if(j == 0 && present[i][rows-1] == 'X') //checks doughnut for top row
      {
        mates++;
        if(i != 0 && i != col-1 && present[i-1][rows-1] == 'X')
        {
          mates++;
        }
        else if(i != 0 && i != col-1 && present[i+1][rows-1] == 'X')
        {
          mates++;
        }
        else if(i == 0 && present[col-1][j] == 'X') //checks for top left square horizontal mate
        {
          mates++;
        }
        else if(i == 0 && present[col-1][rows-1] == 'X') //checks for top left square diagonal mate
        {
          mates++;
        }
        else if(i == 0 && present[i+1][rows-1] == 'X')
        {
          mates++;
        }
        else if(i == 0 && present[col-1][j-1] == 'X')
        {
          mates++;
        }
        else if(i == col-1 && present[0][0] == 'X') //checks top right horizontal mate
        {
          mates++;
        }
        else if(i == col-1 && present[0][rows-1]) //chcek for top right diagonal mate
        {
          mates++;
        }
        else if(i == col-1 && present[i-1][rows-1] == 'X')
        {
          mates++;
        }
        else if(i == col-1 && present[0][j-1] == 'X')
        {
          mates++;
        }
      }

      if(j == rows-1 && present[i][0] == 'X')
      {
        mates++;
        if(i != 0 && i != col-1 && present[i-1][0] == 'X')
        {
          mates++;
        }
        else if(i != 0 && i != col-1 && present[i+1][0] == 'X')
        {
          mates++;
        }
        else if(i == 0 && present[col-1][rows-1] == 'X')
        {
          mates++;
        }
        else if(i == 0 && present[col-1][0] == 'X')
        {
          mates++;
        }
        else if(i == 0 && present[i+1][0] == 'X')
        {
          mates++;
        }
        else if(i == 0 && present[col-1][j+1] == 'X')
        ...
        else if(i == col-1 && present[0][0] == 'X')
        {
          mates++;
        }
        else if(i == col-1 && present[col-1][0] == 'X')
        {
          mates++;
        }
        else if(i == col-1 && present[i-1][0] == 'X')
        {
          mates++;
        }
        else if(i == col-1 && present[0][j+1] == 'X')
      ...
      if(i == 0 && (j != 0 || j != rows-1) && present[col-1][j] == 'X')
      {
        mates++;
        if(present[col-1][j+1] == 'X')
        {
          mates++;
        }
        else if(present[col-1][j-1] == 'X')
        {
          mates++;
        }
      }

      if(i == col-1 && (j != 0 || j != rows-1) && present[0][j] == 'X')
      {
        mates++;
        if(present[0][j+1] == 'X')
        {
...
void DoughnutMode::UpdateGrid()   //will iterate through a generation and display the new generation
{
  bool loopp = true;
  bool loopf = true;
  bool dashAll = true;
...
string DoughnutMode::SetOutputType()
{
  string fileName;
  string output;
  while(true)
